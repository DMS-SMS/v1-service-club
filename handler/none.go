...
func (n None) GetTotalCountOfRecruitments(context.Context, *proto.GetTotalCountOfRecruitmentsRequest, *proto.GetTotalCountOfRecruitmentsResponse) (err error) { return }
func (n None) CheckIfClubLeader(context.Context, *proto.CheckIfClubLeaderRequest, *proto.CheckIfClubLeaderResponse) (err error) { return }
