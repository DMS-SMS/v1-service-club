...
func (n None) GetRecruitmentWithClubUUID(clubUUID string) (_ *model.ClubRecruitment, _ error) { return }
func (n None) GetClubInformsSortByUpdateTime(offset, limit int, field, name string) (_ []*model.ClubInform, _ error) { return }
func (n None) GetRecruitmentsSortByCreateTime(offset, limit int, field, name string) (_ []*model.ClubRecruitment, _ error) { return }
